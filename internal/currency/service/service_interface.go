...
type IService interface {
	...
	CreateCurrency(ctx context.Context, curr entity.Currency) (*entity.Currency, error)
	UpdateCurrency(ctx context.Context, curr entity.Currency) (*entity.Currency, error)
